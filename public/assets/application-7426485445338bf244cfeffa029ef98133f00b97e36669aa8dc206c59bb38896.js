...
(function() {
  App.room = App.cable.subscriptions.create("DataStreamChannel", {
    connected: function() {
      return console.log("Data Stream is connected");
    },
    disconnected: function() {},
    received: function(data) {
      if (data.ENGINE_RPM !== null) {
...
(function() {
  ...
  App.room = App.cable.subscriptions.create("RoomChannel", {
    connected: function() {
      return console.log("Room is connected");
    },
    disconnected: function() {},
    received: function(data) {
